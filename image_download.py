...
def get_images(visible:bool, objectText:str, ObjectNum:int, download_path:str)->None:
	searchtext = objectText;
	num_requested = int(ObjectNum);
...
#get_images(True, "PowerRangers", 100, "imgs/")
